...
namespace ForBarIlanResearch.ModelClasses
{
    class FixationsService
    {
        ...
        {
            List<Fixation>[] values = fixationSetToFixationListDictionary.Values.ToArray();
            int Number_Of_Fixations_Out_Of_AOI_For_Exception = int.Parse(ConfigurationService.getValue(ConfigurationService.Number_Of_Fixations_Out_Of_AOI_For_Exception));
            int Number_Of_Fixations_In_AOI_For_Exception = int.Parse(ConfigurationService.getValue(ConfigurationService.Number_Of_Fixations_In_AOI_For_Exception));
            double exceptionsLimit = double.Parse(ConfigurationService.getValue(ConfigurationService.Dealing_With_Exceptions_Limit_In_Pixels));
